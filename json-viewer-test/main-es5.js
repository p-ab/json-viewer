...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _json_viewer_json_viewer_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./json-viewer/json-viewer.component */
    "./src/app/json-viewer/json-viewer.component.ts");

    var routes = [{
      path: '',
      component: _json_viewer_json_viewer_component__WEBPACK_IMPORTED_MODULE_3__["JsonViewerComponent"]
    }];
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _json_viewer_json_viewer_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./json-viewer/json-viewer.component */
    "./src/app/json-viewer/json-viewer.component.ts");
    /* harmony import */
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _json_viewer_json_viewer_component__WEBPACK_IMPORTED_MODULE_5__["JsonViewerComponent"], _notification_notification_component__WEBPACK_IMPORTED_MODULE_8__["NotificationComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], ngx_dropzone__WEBPACK_IMPORTED_MODULE_6__["NgxDropzoneModule"], ngx_json_viewer__WEBPACK_IMPORTED_MODULE_7__["NgxJsonViewerModule"]],
      providers: [],
  ...
  /***/
  function srcAppJsonViewerJsonViewerComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppJsonViewerJsonViewerComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var JsonViewerComponent = /*#__PURE__*/function () {
      ...
      _createClass(JsonViewerComponent, [{
        ...
        key: "checkFile",
        value: function checkFile(jsonData) {
          var _this = this;

          this.preparedJson = [];

          var getDataType = function getDataType(d) {
            if (d === null) {
              return 'null';
            }
          ...
          var getDataValue = function getDataValue(type, d) {
            if (type === 'object') {
              return "{".concat(Object.keys(d).length, "}");
            }
          ...
          var prepareData = function prepareData(data) {
            ...
            if (!items.length) {
              _this.preparedJson.push({
                ...
                isOpened: false,
                isVisible: false,
                parentKeys: _toConsumableArray(parentKeys)
              });
            }

            items.forEach(function (item) {
              var itemType = getDataType(data[item]);
              var objectedItem = ['array', 'object'].includes(itemType);
              var preparedItem = {
                level: level,
                value: item,
                type: itemType,
                ...
                parentKeys: [].concat(_toConsumableArray(parentKeys), [item])
              };

              _this.preparedJson.push(preparedItem);
        ...
        value: function onSelect(event) {
          ...
          this.files = _toConsumableArray(event.addedFiles);
          fileReader.readAsText(this.files[0], 'UTF-8');

          fileReader.onload = function () {
            try {
              _this2.jsonFile = JSON.parse(fileReader.result);

              _this2.checkFile(_this2.jsonFile);

              _this2.isDropping = 0;
            } catch (e) {
              _this2.notificationType = 'error';
              _this2.notificationText = _this2.notifications.error;
              setTimeout(function () {
                _this2.notificationType = '';
                _this2.notificationText = '';
              }, 5000);
            }
          };
        ...
        key: "toggleObject",
        value: function toggleObject(index) {
          this.preparedJson[index].isOpened = !this.preparedJson[index].isOpened;
          var selectedItem = this.preparedJson[index];
          var stopToggle = 0;
          this.preparedJson.map(function (d, i) {
        ...
        key: "copyData",
        value: function copyData(index) {
          var _this3 = this;

          var selectedItem = this.preparedJson[index];
          var result = {};
          var item = this.jsonFile;

          var _iterator = _createForOfIteratorHelper(selectedItem.parentKeys),
              _step;
          ...
          setTimeout(function () {
            _this3.notificationType = '';
            _this3.notificationText = '';
          }, 5000);
        }
      }, {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(ngx_dropzone__WEBPACK_IMPORTED_MODULE_2__["NgxDropzoneComponent"], {
      "static": false
    ...
    JsonViewerComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./src/app/json-viewer/json-viewer.component.scss"))["default"]]
    })], JsonViewerComponent);
    /***/
  },
  ...
  /***/
  function srcAppNotificationNotificationComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppNotificationNotificationComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], NotificationComponent.prototype, "text", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], NotificationComponent.prototype, "type", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()], NotificationComponent.prototype, "onClick", void 0);
    NotificationComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./src/app/notification/notification.component.scss"))["default"]]
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\Pavel A\Desktop\Devs\json-viewer\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
